// if localStorage has data, show the data
// otherwise, initialize it with empty values.
...
// If there is any text inside the item field, add
// that text to the todo list
...
// make user press 'Enter' to add to to-do list
document.getElementById('item').addEventListener('keydown', function(e) {
  var value = this.value; // user input has value
  if(e.code === 'Enter' && value) { // && enter is pressed
    addItem(value);
  }
});
...
function addItem(value) {
  ...
  // record data and update localStorage
